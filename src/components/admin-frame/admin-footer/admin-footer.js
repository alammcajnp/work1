...
function AdminFooter(props) {
    ...
    return (
        <footer className="app-footer-main" id="footer">
            <HRLine/>
            <div className="footer-bottom">
                <img src={img1} alt="" className="bg1" />
                <img src={img2} alt="" className="bg2" />
                <div className="container-fluid">
                    <div className="wrap-fx row">
                        <div className="Copyright col-md-12 justify-content-center my-1 my-lg-0 col-lg-4 px-0 d-flex">
                            <p>Overthewire 2023 - ALL rights reserved</p>
                        </div>
                        <ul className="widget-social col-md-12 justify-content-center my-1 my-lg-0 col-lg-4 px-0">
                            <li>
                                <Link to="#">
                        ...
                        <ul className="list col-md-12 justify-content-center my-1 my-lg-0 col-lg-4 px-0">
                            <li>
                            ...
                            <li>
                                <Link to="/wargames">Wargames</Link>
                            </li>
                            <li>
